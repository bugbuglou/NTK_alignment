...
args['width'] = 0 #256
args['last'] = 0
args['task'] = 'cifar10_vgg19'#'cifar10_resnet18' #'mnist_fcfree' #'cifar10_vgg19' #'mnist_fc'
...
def process(index, task_des, lr, model, optimizer, loaders = dataloaders, args = args, task_dis = task_dis):
    ...
    for epoch in range(args['epochs']):
        ...
        if epoch == 0:
            ...
            task_name, model_name = task_des.split('_')
            if model_name == 'vgg19':
        ...
        # if loss1 < 5e-2 and loss2 < 5e-2 and stop_2 == False:
